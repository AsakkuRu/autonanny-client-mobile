...
class NannyConsts {
  ...
  static const String iosMapApiKey = String.fromEnvironment(
    'GOOGLE_MAPS_API_KEY',
    defaultValue: 'AIzaSyC5Hq53HqTuBP9DLze6N_3iKyIEAKGb_K4',
  );
  static const String androidMapApiKey = String.fromEnvironment(
    'GOOGLE_MAPS_API_KEY',
    defaultValue: 'AIzaSyAl5F9CDJuusuBxOvYv8YFJ1KJb-5Z8h00',
  );
...
enum UserType {
  ...
  static UserType? fromId(int id) {
    return UserType.values.firstWhere(
      (type) => type.id == id,
      orElse: () => UserType.client, // Default fallback
    );
  }

  // Extension to find a UserType by name
